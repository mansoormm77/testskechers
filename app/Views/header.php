...
<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><img src="<?php echo base_url('images/sketchers-logo.svg'); ?>" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   <!-- <li class="active">
                    ...
                    <li class="active">
                        <a href="<?php echo site_url('user/listing')?>"> <i class="menu-icon fa fa-dashboard"></i>User</a>
                    </li>
                    <li class="">
                        <a href="<?php echo site_url('attendance')?>"> <i class="menu-icon fa fa-dashboard"></i>Add Attandence</a>
                    </li>
                    <li class="">
                        <a href="<?php echo site_url('attendance/listing')?>"> <i class="menu-icon fa fa-dashboard"></i>Attandence</a>
                    </li>
