...
$routes->get('/remove_attendance', 'AttendanceController::removeAttendance');
$routes->get('/attendance/listing', 'AttendanceController::listing');


$routes->get('/attendance/tests', 'AttendanceController::qrCode');
